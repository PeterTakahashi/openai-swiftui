...
class ChatGPTAPI: @unchecked Sendable {
    ...
    init(model: String = "gpt-3.5-turbo", systemPrompt: String = "You are a helpful assistant.", temperature: Double = 0.7) {
        self.model = model
    ...
    private func generateMessages(from text: String) -> [Message] {
        var messages = [systemMessage] + historyList.suffix(2) + [Message(role: "user", content: text)]
    ...
    func sendMessage(_ text: String) async throws -> String {
        ...
        do {
            ...
            print(completionResponse.usage)
